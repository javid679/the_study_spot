/**
 * @author webpantry
 * 	@RequestMapping("survey") is taking request from survey forma nd populating inf DB with Email as Reference to fetch reports from DB for the reviews
 */
...
public class SurveyController {
	...
	public ResponseEntity<?> addSurveyData(@RequestBody HashMap<String,String> surveyRequest) {
		try {
			...
			return ResponseEntity.badRequest().body(new ApiResponse(e.getMessage(), ""));// Handling Excpetions
		}
	}
